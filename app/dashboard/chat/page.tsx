...
const SUGGESTIONS = [
  ...
  { icon: "mail", text: "Show recent supplier quote emails" },
    ...
    <div className="flex h-[calc(100vh-80px)] gap-0 -m-6 md:-m-8 overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-2 px-2">
          {sessions.length === 0 && (
            <p className="text-xs text-center py-8 px-4" style={{ color: "#4a6070" }}>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs" style={{ color: "#4a6070" }}>Live — OEM API connected</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center justify-center h-full gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-sm" style={{ color: "#a0b4c4" }}>
                  Ask about component stock, pricing, alerts, or anything in your procurement workflow.
                </p>
              </div>
        ...
        >
          ...
          >
            <textarea
              ...
              onKeyDown={handleKey}
              placeholder="Ask about stock, alerts, components..."
            ...
            >
              <span
                ...
                style={{
                  fontSize: "18px",
                  color: input.trim() && !loading ? "#7dd3fc" : "#4a6070",
          ...
          <p className="text-xs text-center mt-2" style={{ color: "#4a6070" }}>
            Enter to send · Shift+Enter for new line · Live OEM data via OEM Secrets API
          </p>
        </div>
      </div>
    </div>
