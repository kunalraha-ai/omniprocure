...
interface RotatingTextProps extends Omit<MotionProps, "initial" | "animate" | "exit" | "transition"> {
  texts: string[]
...
const RotatingText = forwardRef<RotatingTextHandle, RotatingTextProps>((props, ref) => {
  ...
  const elements = useMemo<RotatingTextElement[]>(() => {
